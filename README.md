...
[![Version](https://img.shields.io/github/v/release/cashindttacc-dev/cashsys-v2?color=%230567ff&label=Latest%20Release&style=for-the-badge)](https://github.com/cashindttacc-dev/cashsys-v2/releases/latest)
![Downloads](https://img.shields.io/github/downloads/cashindttacc-dev/cashsys-v2/winutil.ps1?label=Total%20Downloads&style=for-the-badge)
...
https://github.com/cashindttacc-dev/cashsys-v2/blob/main/config/preset.json

---

## Build & Develop

See https://github.com/cashindttacc-dev/cashsys-v2/blob/main/.github/CONTRIBUTING.md
...
- [Report an Issue](https://github.com/cashindttacc-dev/cashsys-v2/issues)
