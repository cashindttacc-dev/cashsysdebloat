...
heroBadges:
  - src: https://img.shields.io/github/v/release/cashindttacc-dev/cashsys-v2?color=%230567ff&label=Latest%20Release&style=for-the-badge
    alt: Latest release
    href: https://github.com/cashindttacc-dev/cashsys-v2/releases/latest
  - src: https://img.shields.io/github/downloads/cashindttacc-dev/cashsys-v2/winutil.ps1?label=Total%20Downloads&style=for-the-badge
    alt: Total downloads
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/cashindttacc-dev/cashsys-v2
      icon: external
      variant: secondary
head:
  - tag: meta
    ...
    content: |
      {
        ...
        "downloadUrl": "https://github.com/cashindttacc-dev/cashsys-v2",
...
<section class="wu-section">
	<div class="wu-section-inner wu-text-narrow wu-cta">
		...
		<div class="wu-btn-row">
			...
			<a class="wu-btn wu-btn-secondary" href="https://github.com/cashindttacc-dev/cashsys-v2">
				<Icon name="github" />
				{' View on GitHub'}
			</a>
		</div>
