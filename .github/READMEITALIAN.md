...
![GitHub Downloads (specific asset, all releases)](https://img.shields.io/github/downloads/cashindttacc-dev/cashsys-v2/winutil.ps1?label=Total%20Downloads&style=for-the-badge)
...
In caso di problemi, consulta i [Problemi noti](https://winutil.christitus.com/knownissues/) o [Apri una segnalazione](https://github.com/cashindttacc-dev/cashsys-v2/issues)
...
```ps1
git clone --depth 1 "https://github.com/cashindttacc-dev/cashsys-v2.git"
cd winutil
```
...
[![Contributori](https://contrib.rocks/image?repo=cashindttacc-dev/cashsys-v2)](https://github.com/cashindttacc-dev/cashsys-v2/graphs/contributors)
